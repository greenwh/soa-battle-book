...
### Key Expedition Skill

**Snow's Grace** — Core troop buff skill. Push to Lv4 minimum, Lv5 after 4★. This is Molly's primary contribution to rally leading and Expedition content.

### Skill Leveling Priority

1. Snow's Grace (Expedition) → Lv4, then Lv5
2. Exploration skills → Lv4 for Arena competitiveness
3. Remaining Expedition skills → Lv4 for rally leading
...
- Gloves + Belt → secondary, Epic is fine for now
...
| Beyond +45 MF2 | Low | Diminishing returns — save resources for Mia's arrival |

## The Mia Transition

When your server enters Gen 3 and Mia becomes available on Lucky Wheel:

1. Acquire Mia via Lucky Wheel (120 spins, ~175,500 gems)
2. Transfer ALL of Molly's Lancer gear to Mia — free, immediate
3. Molly moves to bench or secondary Lancer role
4. Mia takes over as primary Lancer with fully enhanced Mythic gear from day one

::: warning Philly ≠ Mia
Philly is a Gen 2 Mythic Lancer — benched, no further development planned. Don't confuse her with Mia (Gen 3). Mia is the target; Philly is a skip.
:::
